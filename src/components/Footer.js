...
function Pied(){
    ...
    <Navbar.Brand className="d-flex justify-content-center">
        <a href="" onClick={() => {navigate("/description")}}>
        <img
        src={Logo}
        width="120"
        height="60"
      ...
      />
               ...
               </Row><hr className="bg-light"/>
               <Row>
                   <p className="text-center text-light">Made with <FaHeart className="danger"/> by Fouad Med &copy; {new Date().getFullYear()} Copyright: <a href="/"> fouad.com </a></p>
               </Row>
           </Container>
        </StyFooter>
